...
export async function loader({ params }: Route.LoaderArgs) {
  try {
    const [productRes, discountRes] = await Promise.all([
      ...
      discountApiService.getDiscountsByProduct(params.id).catch(() => ({ data: { coupons: [] } })),
    ]);
                  ...
                  {product.imageFile ? (
                    <img
                      ...
                      onError={(e) => {
                        ...
                        e.currentTarget.parentElement?.classList.add('flex', 'flex-col', 'items-center', 'text-primary/30');
                    ...
                    <div className="flex flex-col items-center text-primary/30">
                      ...
                      <span className="text-2xl font-bold">{product.categories[0] || 'Produit'}</span>
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm text-muted-foreground">(4.8) 256 avis</span>
                </div>
              ...
              <div className="prose dark:prose-invert max-w-none">
                <h2 className="text-xl font-semibold mb-3">Description du produit</h2>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    { id: 'quality', icon: Cpu, text: "Processeur haute performance" },
                    { id: 'battery', icon: Battery, text: "Batterie longue durée" },
                    { id: 'connectivity', icon: Wifi, text: "Connectivité avancée" },
                    { id: 'storage', icon: HardDrive, text: "Stockage optimisé" }
                  ].map((feature) => {
              ...
              {/* Quantity Selector */}
              <div>
                <label htmlFor="quantity-input" className="text-sm font-semibold mb-3 block">Quantité</label>
      ...
      <section className="py-16 bg-slate-50 dark:bg-slate-900">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12">Détails du produit</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Tous nos produits sont garantis 2 ans. Service après-vente rapide et efficace.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Livraison gratuite dès 50€ d'achat. Livraison express disponible en 24-48h.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <h3 className="font-semibold text-lg mb-2">Retours 30 jours</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Pas satisfait ? Retournez le produit sous 30 jours pour un remboursement complet.
                  </p>
                </CardContent>
              </Card>
            </div>
