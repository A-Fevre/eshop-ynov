...
public static class OrderMapperExtensions
{
    ...
    public static CreateOrderCommand MapToCreateOrderCommand(BasketCheckoutEvent message)
    {
        ...
        var orderDto = new OrderDto(
            ...
            OrderItems:
            [
                new OrderItemDto(orderId, new Guid("5334c996-8457-4cf0-815c-ed2b77c4ff61"), "IPhone X", 2, 500),
                new OrderItemDto(orderId, new Guid("c67d6323-e8b1-4bdf-9a75-b0d0d2e7e914"), "Samsung 10",1, 400)
            ]);
